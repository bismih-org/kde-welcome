...
class SoundComp(QWidget):
    ...
    def initUI(self):
        ...
        lb_b_panel = BLabel("Alt panelde her uygulamanın \nsesi kısılıp ayarlanabilmektedir.", is_bold=True)
        ...
        lb_menu = BLabel("Özel menü içerisindeki ses \nefektleriyle gürültü engelleme \nyapılabilmektedir.", is_bold=True)
